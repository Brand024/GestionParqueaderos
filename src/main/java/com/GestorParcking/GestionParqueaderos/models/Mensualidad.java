...
public class Mensualidad {
    ...
    public Mensualidad(int id_mensualidad, String placa, Date fecha_inicio, Date fecha_fin, float valor, boolean pagado) {
    ...
    // Getters y Setters
    public int getId_mensualidad() { return id_mensualidad; }
    public void setId_mensualidad(int id_mensualidad) { this.id_mensualidad = id_mensualidad; }

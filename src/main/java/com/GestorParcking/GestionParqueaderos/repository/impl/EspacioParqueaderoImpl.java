...
public class EspacioParqueaderoImpl implements IEspacioParqueaderoDao {
    ...
    public List<EspacioParqueadero> listarDisponibles() {
        ...
        try (Connection con = Conexion.conectar();
            ...
            while (rs.next()) {
                ...
                e.setTipo_celda(rs.getString("tipo_celda"));
    ...
    // ✅ NUEVO MÉTODO - Listar todos los espacios (disponibles y ocupados)
    @Override
    public List<EspacioParqueadero> listarTodos() {
        String sql = "SELECT id_espacio, numero, piso, tipo_celda, estado FROM EspacioParqueadero";
        List<EspacioParqueadero> lista = new ArrayList<>();
        ...
        try (Connection con = Conexion.conectar();
            ...
            System.err.println("Error al listar todos los espacios: " + e.getMessage());
        }
        return lista;
    }
    ...
    public EspacioParqueadero buscarPorNumero(int numero) {
        ...
        try (Connection con = Conexion.conectar();
            ...
            if (rs.next()) {
                ...
                espacio.setTipo_celda(rs.getString("tipo_celda"));
